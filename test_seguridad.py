...
def test_argument_injection_nmap_bloqueada():
    ...
    assert ob._safe_target('-oG/algo') is False
...
def test_edges():
    ...
    assert ob._validate('-example.com', 'domain') is False
    assert ob._validate('exam ple.com', 'domain') is False
    assert ob._validate('a' * 300, 'domain') is False

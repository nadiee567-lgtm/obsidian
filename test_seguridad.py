...
def test_bordes():
    ...
    assert ob._validar('-example.com', 'dominio') is False   # leading hyphen
    assert ob._validar('exam ple.com', 'dominio') is False   # space
    assert ob._validar('a' * 300, 'dominio') is False         # too long
